...
const Route ROUTES[] = {
  ...
  {"tweets","poll-multi-vote","POST","/api/tweets/:id/poll/multi-vote",1,PAYLOAD_BODY,NULL},
  ...
  {"dm","draft","POST","/api/dm/conversations/:id/draft",1,PAYLOAD_BODY,NULL},
  ...
  {"admin","support-tickets","GET","/api/admin/support-tickets",0,PAYLOAD_QUERY,NULL},
  {"admin","claim-support-ticket","POST","/api/admin/support-tickets/:id/claim",1,PAYLOAD_BODY,NULL},
  {"admin","support-ticket-draft","GET","/api/admin/support-tickets/:id/draft",1,PAYLOAD_QUERY,NULL},
  {"admin","support-ticket","GET","/api/admin/support-tickets/:id",1,PAYLOAD_QUERY,NULL},
  {"admin","reply-support-ticket","POST","/api/admin/support-tickets/:id/reply",1,PAYLOAD_BODY,NULL},
  {"admin","close-support-ticket","POST","/api/admin/support-tickets/:id/close",1,PAYLOAD_BODY,NULL},
